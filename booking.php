                    ...
                    <div class="span9">
                        <div class="content">
                            ...
                            $q = mysqli_query($connection, "SELECT
                                ...
                                FROM
                                `booking` ") or die(mysqli_error($connection));?>
                            ...
                            echo "<th>Tour_id</th>";
                            echo "<th>Hotel Id</th>";
                            echo "<th>Rate Tour</th>";
                            
                            echo "<th>Rate Hotel</th>";
                            echo "<th>Date of Book</th>";
                            ...
                            while($row = mysqli_fetch_array($q)){
                                ...
                                echo "<td>{$row['rate_tour']}</td>";
                                    echo "<td>{$row['rate_hotel']}</td>";
                                   
                                echo "<td>{$row['date_of_book']}</td>";
                                echo "<td>{$row['total_persons']}</td>";
                                echo "<td>{$row['seen']}</td>";
                                echo "<td>{$row['confirmed']}</td>";
                                echo "<td>{$row['rejected']}</td>";
    echo "<td><a href='seenbooking.php?id={$row['booking_id']}, admin_id = {$_SESSION['admin_id']}'>Mark Seen</a></td>";
    echo "<td><a href='confirmbooking.php?id={$row['booking_id']}, admin_id = {$_SESSION['admin_id']}'>Confirm</a></td>";
    echo "<td><a href='rejectbooking.php?id={$row['booking_id']}, admin_id = {$_SESSION['admin_id']}'>Reject</a></td>";
