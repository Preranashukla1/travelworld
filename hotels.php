                ...
                <div class="row">
                    ...
                    <div class="span9">
                        <div class="content">
                            ...
                            FROM
                                `hotels` ") or die(mysqli_error($connection));?>
                            
                            <a href="addhotels.php" class = 'btn' >Add New Hotel</a>
                            ...
                            while($row = mysqli_fetch_array($q)){
                                ...
                                echo "<td>{$row['hdes_country']}</td>";
                                echo "<td>{$row['hdes_state']}</td>";
                                echo "<td>{$row['hdes_city']}</td>";
                                echo "<td>{$row['hhighlights']}</td>";
                                    echo "<td>{$row['charges_per_night']}</td>";
                                   
                               // echo "<td>{$row['himage']}</td>";
                                  ?> 
                                 <td> <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['himage']); ?>" /></td>
                           <?php
                           
                           echo "<td>{$row['activehotel']}</td>";
                                   
    echo "<td><a href='activatehotel.php?id={$row['hotel_id']}, admin_id = {$_SESSION['admin_id']}'>Activate</a></td>";
      echo "<td><a href='deactivatehotel.php?id={$row['hotel_id']}, admin_id = {$_SESSION['admin_id']}'>Deactivate</a></td>";
  
    echo "<td><a href='edithotel.php?id={$row['hotel_id']}, admin_id = {$_SESSION['admin_id']}'>Edit</a></td>";
