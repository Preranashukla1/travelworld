                    ...
                    <div class="span9">
                        <div class="content">
                            <div class="btn-controls">
                                <div class="btn-box-row row-fluid" style="background-color: white">
                                            <?php
                            ...
                            FROM
                                `admin` ") or die(mysqli_error($connection));
                            ...
                            echo "<tr>";
                            echo "<th>Email_id</th>";
                            echo "<th>Phone_No1</th>";
                            echo "<th>Phone_No2</th>";
                            echo "<th>Salary</th>";
                            echo "<th>Age</th>";
                            echo "<th>Role_id</th>";
                            echo "</tr>";
                            ...
                            while($row = mysqli_fetch_array($q)){
                                ...
                                echo "<td>{$row['ad_phone1']}</td>";
                                echo "<td>{$row['ad_phone2']}</td>";
                                echo "<td>{$row['salary']}</td>";
                                    echo "<td>{$row['age']}</td>";
                                    echo "<td>{$row['role_id']}</td>";
    echo "<td><a href='editadmin.php?id={$row['admin_id']}'>edit</a></td>";
