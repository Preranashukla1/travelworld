                ...
                <div class="row">
                    ...
                    <div class="span9">
                        <div class="content">
                            ...
                            FROM
                                `query` where seen_status = 0 and complete_status = 0") or die(mysqli_error($connection));?>
                                    
                                    <a href="query.php" class = 'btn' >Queries Page</a>
                                    <a href="seenqueries.php" class = 'btn' >Yet To Complete</a>
                                    <a href="completedqueries.php" class = 'btn' >Done Queries</a>
