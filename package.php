                ...
                <div class="row">
                    ...
                    <div class="span9">
                        <div class="content">
                            ...
                            <a href="addpack.php" class = 'btn' >Add New Pack</a>
                            ...
                            echo "<th>Per Person Charges</th>";
                            echo "<th>Days</th>";
                            echo "<th>Nights</th>";
                            echo "<th>Tour Type Id</th>";
                            echo "<th>Image</th>";
                            echo "<th>Active</th>";
                            ...
                            while($row = mysqli_fetch_array($q)){
                                ...
                                echo "<td>{$row['des_country']}</td>";
                                echo "<td>{$row['des_state']}</td>";
                                echo "<td>{$row['des_city']}</td>";
                                echo "<td>{$row['highlights']}</td>";
                                    echo "<td>{$row['charge_per_person']}</td>";
                                   
                                echo "<td>{$row['days_stay']}</td>";
                                echo "<td>{$row['night_stay']}</td>";
                                     echo "<td>{$row['tour_type_id']}</td>";?>
                      
                            <td> <img src="data:jpg/jpeg/png;charset=utf8;base64,<?php echo base64_encode($row['image']); ?>" /></td>
                            <?php echo "<td>{$row['activepack']}</td>";
                                   
    echo "<td><a href='activatepack.php?id={$row['tour_id']}, admin_id = {$_SESSION['admin_id']}'>Activate</a></td>";
     echo "<td><a href='deactivatepack.php?id={$row['tour_id']}, admin_id = {$_SESSION['admin_id']}'>Deactivate</a></td>";
   
    echo "<td><a href='editpack.php?id={$row['tour_id']}, admin_id = {$_SESSION['admin_id']}'>Edit</a></td>";
