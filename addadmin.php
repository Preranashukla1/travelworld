...
if($_POST){
    ...
    $q = mysqli_query($connection, "insert into admin(ad_email, adpasswd, ad_phone1, ad_phone2, salary, age, role_id)
            values('{$ad_email}','{$adpasswd}','{$ad_phone1}','{$ad_phone2}', '{$salary}', '{$age}','{$role_id}')") or 
    die(mysqli_error($connection));
    if($q){
        ...
        <div class="container mt-4 mb-4 p-3 d-flex justify-content-center">
            <div class="card p-4">
                ...
                <div class=" image d-flex flex-column justify-content-center align-items-center"> 
                    <div class="d-flex flex-row justify-content-center align-items-center gap-2"> <span class="idd1">&nbsp;&nbsp;EMAIL_ID:<input type="email" value="" name="ad_email"/></div><br/>
                    <div class="d-flex flex-row justify-content-center align-items-center gap-2"> <span class="idd1">PASSWORD:<input type="password" value=""name="ad_passwd"/></span></div> <br/>
                    <div class="d-flex flex-row justify-content-center align-items-center gap-2"> <span class="idd1">Phone no1:<input type="tel" value="" name="ad_phone1"/> </div><br/>
                    <div class="d-flex flex-row justify-content-center align-items-center gap-2"> <span class="idd1">Phone no2:<input type="tel" value="" name="ad_phone2"/> </div><br/>
                    <div class="d-flex flex-row justify-content-center align-items-center gap-2"> <span class="idd1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;SALARY:<input type="float" value="" name="salary"/> </div><br/>
                    <div class="d-flex flex-row justify-content-center align-items-center gap-2"> <span class="idd1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;AGE:<input type="number" value="" name="age"/></div><br/>


                    <div class="d-flex flex-row justify-content-center align-items-center gap-2"> <span class="idd1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ROLE_ID:<input type="number" value="" name="role_id"/></div><br/>
                    <input type="submit" value="Edit" class="btn1 btn-dark">
                    <a href="newad.php" style="color: black; font-size: 20"> Cancel </a>
