       ...
       <div class="col-md-12">
          <div class="search-wrap-1 ftco-animate">
             <div class="tab-pane fade show active" id="v-pills-1" role="tabpanel" aria-labelledby="v-pills-nextgen-tab">
                 <form method="post" action="searchedvaluepack.php">
...
<section class="ftco-section">
			<div class="container">
				...
				<div class="row">
                                    ...
                                    $editq2 = mysqli_query($connection, "select * from package where des_country = '$pack' or 
                                            des_state = '$pack' or des_city = '$pack' or pack_name = '$pack' or highlights = '$pack' "
                                            . "and activepack=1") or 
					...
					echo '<div class="col-md-4 ftco-animate">';
						echo '<div class="project-wrap">';?>
							...
							echo '<div class="text p-4">';
								...
								echo '</ul>';
                                                                echo "<a href='bookingpro.php?tour_id = {$editrow2['tour_id']}' class='btn btn-primary ' style='padding:0px 0px 0px 5px;'>Book It Now</a>";
							echo '</div>';
