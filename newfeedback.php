...
<head>
                ...
                <div class="row">
                    ...
                    <div class="span9">
                        <div class="content">
                            ...
                            FROM
                                `feedback` where checked = 0") or die(mysqli_error($connection));?>
                                    <a href="feedback.php" class = 'btn' >Feedback Page</a>
                                    <a href="checkedfeedback.php" class = 'btn' >Old Feedback</a>
    ...
    echo "<td><a href='checkfeedback.php?id={$row['feedback_id']}, admin_id = {$_SESSION['admin_id']}'>Mark As Check</a></td>";
