 ...
 <div class="container container-2">
  <div class="row">
       ...
       <?php
                                    ...
                                    $editq2 = mysqli_query($connection, "select * from hotels where hdes_country = '$pack' or 
                                            hdes_state = '$pack' or hdes_city = '$pack' or hotel_name = '$pack' or hhighlights = '$pack' "
                                            . "and activehotel =1") or 
                				...
                				<?php
                                        ...
                                        echo "<div class='text p-4'>";
                                         ...
                                         echo "</ul>";
                                          ...
                                          echo "<a href='bookingpro.php?hotel_id = {$editrow2['hotel_id']}' class='btn btn-primary ' style='padding:0px 0px 0px 5px;'>Book It Now</a>";
                                       echo "</div>";
                                     echo "</div>";
                                    echo "</div>";
