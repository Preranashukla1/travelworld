        ...
        <div class="container mt-4 mb-4 p-3 d-flex justify-content-center">
            <div class="card p-4">
                ...
                <div class=" image d-flex flex-column justify-content-center align-items-center"> 
                    <div class="d-flex flex-row justify-content-center align-items-center gap-2"> <span class="idd1">Pack Name:<input type="varchar" value="<?php echo $editrow['pack_name'] ?>" name="pack_name"/></div><br/>
                    <div class="d-flex flex-row justify-content-center align-items-center gap-2"> <span class="idd1">Country:<input type="varchar" value="<?php echo $editrow['des_country'] ?>"name="des_country"/></span></div> <br/>
                    <div class="d-flex flex-row justify-content-center align-items-center gap-2"> <span class="idd1">State:<input type="varchar" value="<?php echo $editrow['des_state'] ?>" name="des_state"/> </div><br/>
                    <div class="d-flex flex-row justify-content-center align-items-center gap-2"> <span class="idd1">City:<input type="varchar" value="<?php echo $editrow['des_city'] ?>" name="des_city"/> </div><br/>
                    <div class="d-flex flex-row justify-content-center align-items-center gap-2"> <span class="idd1">Highlights:<input type="varchar" value="<?php echo $editrow['highlights'] ?>" name="highlights"/> </div><br/>
                    <div class="d-flex flex-row justify-content-center align-items-center gap-2"> <span class="idd1">Per Person Rate:<input type="number" value="<?php echo $editrow['charge_per_person'] ?>" name="charge_per_person"/></div><br/>
                     <div class="d-flex flex-row justify-content-center align-items-center gap-2"> <span class="idd1">Days:<input type="number" value="<?php echo $editrow['days_stay'] ?>" name="days_stay"/> </div><br/>
                    <div class="d-flex flex-row justify-content-center align-items-center gap-2"> <span class="idd1">Nights:<input type="number" value="<?php echo $editrow['night_stay'] ?>" name="night_stay"/> </div><br/>
                    <div class="d-flex flex-row justify-content-center align-items-center gap-2"> <span class="idd1">Tour Type Id:<input type="number" value="<?php echo $editrow['tour_type_id'] ?>" name="tour_type_id"/> </div><br/>
                    ...
                    <div class="d-flex flex-row justify-content-center align-items-center gap-2"> <span class="idd1">Active Status:<input type="number" value="<?php echo $editrow['activepack'] ?>" name="activepack"/> </div><br/>
